...
<body>
		...
		<div class="container d-flex align-items-center">
			...
			<nav class="nav-menu d-none d-lg-block">
				<ul>
					...
					<c:if test="${empty vo}">
						<li class="book-a-table text-center"><a
							href="../Member/loginForm.jsp">login</a></li>
					</c:if>
				</ul>
			</nav>
			<!-- .nav-menu -->
				...
				<c:forEach items="${storeShowList}" var="store">
					<div class="item ${store.area} ">
						<a href="${pageContext.request.contextPath}/Store/storeDetail.do?storeId=${store.storeId}"
							...
							</div> <img class="img-fluid" src="../store_img/${store.imageUrl}">
						</a>
					</div>
				</c:forEach>
	...
	<!-- Vendor JS Files -->
	<script src="storeAssets/vendor/jquery/jquery.min.js"></script>
	<!-- 레이아웃 -->
	<script src="storeAssets/vendor/aos/aos.js"></script>
	<!-- 이름 덧씌우기 -->
	<script src="storeAssets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
	<!-- 레이아웃 -->


	<!-- Template Main JS File -->
	<script src="storeAssets/js/storeMain.js"></script>
	<!-- 레이아웃 -->
