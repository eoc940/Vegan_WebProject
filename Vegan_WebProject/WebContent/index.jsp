    ...
    function callback() {
      if (xhr.readyState == 4) {
        if (xhr.status == 200) {
          ...
          if (list != null)
            for (var i = 0; i < 9; i++) {
              resultView.innerHTML += list[i].name + " <img src=store_img/" + list[i].imageUrl +
          ...
          <div class="carousel-item active" style="background: url(./assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">Veganism, the natural extension of vegetarianism, is an
                  integral component of a true cruelty-free lifestyle. Living vegan provides numerous benefits to
                  animals’ lives, to the environment, and to our own health–through a healthy diet and lifestyle.</p>
                <!-- <div>
          ...
          <div class="carousel-item" style="background: url(./assets/img/slide/slide-2.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">The Academy of Nutrition and Dietetics states that an
                  appropriately planned vegan diet is healthful for all stages of life. They further advise that
                  plant-based diets may provide a variety of preventative health benefits. Of course, as with any diet,
                  a poorly planned vegan diet could be dangerous or unhealthful. </p>
                <!-- <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Today's Menu</a>
                  <a href="#book-a-table" class="btn-book animate__animated animate__fadeInUp scrollto">Best Restaurant</a>
                </div> -->
